...
import HelloSharepoint from './components/HelloSharepoint';
import { IHelloSharepointProps } from './components/IHelloSharepointProps';
...
export default class HelloSharepointWebPart extends BaseClientSideWebPart<IHelloSharepointWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IHelloSharepointProps> = React.createElement(
      HelloSharepoint,
      {
